let questions = [
    ...
    },
    {
        ...
        options: ["Na tag body", "Na tag head", "Tanto na tag body quanto a head estão corretas"],
        answer: 2,
    },
    {
    ...
    },
    {
        ...
        options: ['alertBox("Olá Mundo")', 'msgBox("Olá Mundo")', 'msg("Olá Mundo")', 'alert("Olá Mundo")'],
        answer: 3,
    },
    {
        question: "Como você cria uma função no Javascript?",
        options: ["function:minhaFuncao()", "function = minhaFuncao()", "function minhaFuncao()"],
        answer: 2,
    },
    {
